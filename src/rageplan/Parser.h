...
namespace PARSER{
    ...
    bool parseIncorapFile(INCORAPMWE_PARAMS& problem_params, WORKER_PARAMS& worker_params, string inputFile){
        std::ifstream infile(inputFile);
        string param;
        string s_value;
        ...
        problem_params.description = "INCORAP MWE - Expert lvl. " + std::to_string(worker_params.expertise);
        return true;
    }
    ...
    bool parseAssemblyFile(ASSEMBLY_ROBOT_PARAMS& problem_params, ASSEMBLY_PARAMS& worker_params, string inputFile){
        std::ifstream infile(inputFile);
        string param;
        string s_value;
    ...
    bool parseHotelFile(HOTEL_ROBOT_PARAMS& problem_params, HOTEL_PARAMS& worker_params, string inputFile){
        std::ifstream infile(inputFile);
        string param;
        string s_value;
        ...
        problem_params.description = "INSECT HOTEL assembly - Perception accuracy " + std::to_string(problem_params.perceive) + ", Bring accuracy " + std::to_string(problem_params.bring_success) + ", PGS entropy = " + std::to_string(problem_params.entropy);
        return true;
    }
